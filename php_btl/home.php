...
function get_chu_de() {
    ...
    if ($result->num_rows > 0) {
        return $result->fetch_assoc()['chu_de'] ?? null;
    }
...
$chu_de = get_chu_de();
$chu_de_khac = get_chu_de();
while($chu_de_khac == $chu_de){
    $chu_de_khac = get_chu_de();
}
?>
...
<body>
    ...
    <main>
        <!-- Banner -->
        <div id="carouselExampleSlidesOnly" class=" main_banner carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../php_btl/image/banner_01.jpg" class="d-block w-20"  alt="banner1">
                </div>
                <div class="carousel-item">
                    <img src="../php_btl/image/banner_02.jpg" class="d-block w-20"  alt="banner2">
                </div>
                <div class="carousel-item">
                    <img src="../php_btl/image/banner_03.png" class="d-block w-20"  alt="banner3">
                </div>
            </div>
        </div>
        ...
        <div class="container" style="min-height: 550px;">
            ...
            <div class="title_center">
                <h>CHỦ ĐỀ</h>
                <h1 class="border-bottom border-secondary-subtle"><?php echo $chu_de?></h1>
            </div>
            <div class="row"> 
            ...
            <!-- <div class="col-md-3">
                <div class="card">
                    <img src="https://mimosawedding.net/wp-content/uploads/2023/09/vay-duoi-ca-co-cach-dieu-co-yem-1.jpg" width="100%" class="card-img-top">
                    <div >
                        <a href="#" class="btn btn-outline-warning card-col card-foot" >Add to cart
                            <img src="../php_btl/image/bag.svg" alt="Bootstrap" width="30" height="24">
                        </a>                   
                    </div>
                </div>
                <div class="price">
                    <h>váy</h>    
                    <p>Giá thuê: 10.000.000 vnđ</p>   
                </div>
            </div> -->

            <div class="row justify-content-center border-bottom">
                <div class="col-2 text-center button_subject">
                    <a class="btn button_subject" href="../php_btl/sanpham_chude.php?chu_de=<?php echo $chu_de?>">XEM THÊM</a>
                </div>
        ...
        <div class="container" style="min-height: 550px;">
            ...
            <div class="title_center">
                <h>CHỦ ĐỀ</h>
                <h1 class="border-bottom border-secondary-subtle"><?php echo $chu_de_khac?></h1>
            </div>
            <div class="row"> 
            ...
            <div class="row justify-content-center ">
                <div class="col-2 text-center button_subject ">
                    <a class="btn button_subject" href="../php_btl/sanpham_chude.php?chu_de=<?php echo $chu_de_khac?>">XEM THÊM</a>
                </div>
